  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved idea as @idea" do
        ...
        post :create, {:idea => { "string" => "invalid value" }}, valid_session
        assigns(:idea).should be_a_new(Idea)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested idea" do
        ...
        Idea.any_instance.should_receive(:update_attributes).with({ "string" => "" })
        put :update, {:id => idea.to_param, :idea => { "string" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the idea as @idea" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Idea.any_instance.stub(:save).and_return(false)
        put :update, {:id => idea.to_param, :idea => { "string" => "invalid value" }}, valid_session
        assigns(:idea).should eq(idea)
      end
